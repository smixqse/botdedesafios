  ...
  switch (search) {
    ...
    default:
      if (args.length < 1) {
        ...
        let results = resultsC.array().sort(function(a,b){if(a.name.length >= b.name.length){return 1}else{return -1}});
        if (results.length < 1) {
